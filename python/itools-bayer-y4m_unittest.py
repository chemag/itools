...
readVideoY4MTestCases = [
    ...
    # bayer10->ydgcocg10.planar (expanded-planar)
    {
        ...
        "i_bayer_planar": (
            {
                ...
                "G": np.array([[256, 192], [128, 64]], dtype=np.uint16),
                "g": np.array([[512, 576], [640, 704]], dtype=np.uint16),
        ...
        "i_ydgcocg_planar": (
            {
                "Y": np.array([[447, 448], [448, 448]], dtype=np.uint16),
                "D": np.array([[640, 704], [768, 832]], dtype=np.uint16),
                "C": np.array([[0, 64], [128, 192]], dtype=np.uint16),
                "c": np.array([[448, 448], [448, 448]], dtype=np.uint16),
            },
        ),
    ...
    # bayer_bggr8->rgb8.planar
    {
        ...
        "o_frames": (
            b"\x05\x05\x06\x07\x05\x05\x06\x07\x09\x09\x0a\x0b\x0d\x0d\x0e\x0f\x02\x01\x02\x03\x04\x05\x06\x06\x08\x09\x0a\x0b\x0c\x0c\x0e\x0c\x00\x01\x02\x02\x04\x05\x06\x06\x08\x09\x0a\x0a\x08\x09\x0a\x0a",
            b"\x15\x15\x16\x17\x15\x15\x16\x17\x19\x19\x1a\x1b\x1d\x1d\x1e\x1f\x12\x11\x12\x13\x14\x15\x16\x16\x18\x19\x1a\x1b\x1c\x1c\x1e\x1c\x10\x11\x12\x12\x14\x15\x16\x16\x18\x19\x1a\x1a\x18\x19\x1a\x1a",
        ),
        "output": b"YUV4MPEG2 W4 H12 F25:1 Ip A0:0 Cmono XCOLORRANGE=FULL XEXTCS=rgb8.planar\nFRAME\n\x05\x05\x06\x07\x05\x05\x06\x07\x09\x09\x0a\x0b\x0d\x0d\x0e\x0f\x02\x01\x02\x03\x04\x05\x06\x06\x08\x09\x0a\x0b\x0c\x0c\x0e\x0c\x00\x01\x02\x02\x04\x05\x06\x06\x08\x09\x0a\x0a\x08\x09\x0a\x0aFRAME\n\x15\x15\x16\x17\x15\x15\x16\x17\x19\x19\x1a\x1b\x1d\x1d\x1e\x1f\x12\x11\x12\x13\x14\x15\x16\x16\x18\x19\x1a\x1b\x1c\x1c\x1e\x1c\x10\x11\x12\x12\x14\x15\x16\x16\x18\x19\x1a\x1a\x18\x19\x1a\x1a",
    },
    # RG10->rgb10.planar
    {
    ...
    # bayer_bggr8->yuv444p8.mono
    {
        ...
        "i_bayer_planar": (
            ...
            {
                "B": np.array([[16, 18], [24, 26]], dtype=np.uint8),
                "G": np.array([[17, 19], [25, 27]], dtype=np.uint8),
                "g": np.array([[20, 22], [28, 30]], dtype=np.uint8),
                "R": np.array([[21, 23], [29, 31]], dtype=np.uint8),
            },
        ),
        "i_rgb_planar": (
            {
        ...
        "o_pix_fmt": "yuv444p8.mono",
        "o_frames": (
            b"\x03\x02\x03\x04\x04\x05\x06\x06\x08\x09\x0a\x0b\x0c\x0c\x0e\x0d\x7f\x80\x80\x7f\x80\x80\x80\x80\x80\x80\x80\x80\x7e\x7f\x7e\x7f\x82\x83\x83\x83\x81\x80\x80\x81\x81\x80\x80\x80\x81\x81\x80\x82",
            b"\x13\x12\x13\x14\x14\x15\x16\x16\x18\x19\x1a\x1b\x1c\x1c\x1e\x1d\x7f\x80\x80\x7f\x80\x80\x80\x80\x80\x80\x80\x80\x7e\x7f\x7e\x7f\x82\x83\x83\x83\x81\x80\x80\x81\x81\x80\x80\x80\x81\x81\x80\x82",
        ),
        "output": b"YUV4MPEG2 W4 H12 F25:1 Ip A0:0 Cmono XCOLORRANGE=FULL XEXTCS=yuv444p8.mono\nFRAME\n\x03\x02\x03\x04\x04\x05\x06\x06\x08\x09\x0a\x0b\x0c\x0c\x0e\x0d\x7f\x80\x80\x7f\x80\x80\x80\x80\x80\x80\x80\x80\x7e\x7f\x7e\x7f\x82\x83\x83\x83\x81\x80\x80\x81\x81\x80\x80\x80\x81\x81\x80\x82FRAME\n\x13\x12\x13\x14\x14\x15\x16\x16\x18\x19\x1a\x1b\x1c\x1c\x1e\x1d\x7f\x80\x80\x7f\x80\x80\x80\x80\x80\x80\x80\x80\x7e\x7f\x7e\x7f\x82\x83\x83\x83\x81\x80\x80\x81\x81\x80\x80\x80\x81\x81\x80\x82",
    },
    {
    ...
    {
        "name": "yuv422p8-yuv422p8.mono",
        "debug": 0,
        "input": b"YUV4MPEG2 W4 H4 F25:1 Ip A0:0 C422 XCOLORRANGE=FULL XEXTCS=yuv422p8\nFRAME\n\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x7e\x7e\x7d\x7d\x7e\x7e\x7d\x7d\x83\x83\x82\x82\x83\x83\x82\x82",
        "num_frames": 1,
        "absolute_tolerance": 2,
        "i_pix_fmt": "yuv422p8",
        "o_pix_fmt": "yuv422p8.mono",
        "output": b"YUV4MPEG2 W4 H8 F25:1 Ip A0:0 Cmono XCOLORRANGE=FULL XEXTCS=yuv422p8.mono\nFRAME\n\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x7e\x7e\x7d\x7d\x7e\x7e\x7d\x7d\x83\x83\x82\x82\x83\x83\x82\x82",
    },
    {
        # XXX
        "name": "yuv422p8-SRGGB8",
        "debug": 0,
        "input": b"YUV4MPEG2 W4 H4 F25:1 Ip A0:0 C422 XCOLORRANGE=FULL XEXTCS=yuv422p8\nFRAME\n\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x7e\x7e\x7d\x7d\x7e\x7e\x7d\x7d\x83\x83\x82\x82\x83\x83\x82\x82",
        "num_frames": 1,
        "absolute_tolerance": 4,
    ...
    {
        "name": "yuv422p10-SRGGB10",
        "debug": 0,
        "input": b"YUV4MPEG2 W4 H4 F25:1 Ip A0:0 C422p10 XCOLORRANGE=FULL XEXTCS=yuv422p10\nFRAME\n",
        "num_frames": 1,
        "absolute_tolerance": 8,
        "i_pix_fmt": "yuv422p10",
        "o_pix_fmt": "SRGGB10",
        "output": b"YUV4MPEG2 W4 H4 F25:1 Ip A0:0 Cmono10 XCOLORRANGE=FULL XEXTCS=RG10\nFRAME\n\x33\x00\x52\x00\x32\x00\x57\x00\x57\x00\x22\x00\x55\x00\x2a\x00\x34\x00\x55\x00\x33\x00\x58\x00\x57\x00\x22\x00\x55\x00\x2b\x00",
    },
]
...
convertRawImageFileTestCases = [
    ...
    },
    {
        ...
        "width": 4,
        "height": 4,
        "input": b"\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x80\x81\x82\x83\x80\x81\x82\x83\x7f\x7e\x7d\x7c\x7f\x7e\x7d\x7c",
        "i_pix_fmt": "yuv422p8",
        "colorrange": itools_common.ColorRange.full,
        "o_pix_fmt": "yuv422p8.mono",
        "output": b"YUV4MPEG2 W4 H8 F25:1 Ip A0:0 Cmono XCOLORRANGE=FULL XEXTCS=yuv422p8.mono\nFRAME\n\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x80\x81\x82\x83\x80\x81\x82\x83\x7f\x7e\x7d\x7c\x7f\x7e\x7d\x7c",
    },
    {
        "name": "yuv422p8.mono-yuv420p8",
        "debug": 0,
        "width": 4,
        "height": 4,
        "input": b"\x03\x02\x03\x04\x05\x06\x07\x07\x09\x0a\x0b\x0c\x0c\x0c\x0e\x0d\x80\x81\x82\x83\x80\x81\x82\x83\x7f\x7e\x7d\x7c\x7f\x7e\x7d\x7c",
...
class MainTest(itools_unittest.TestCase):
    ...
    def testVideoY4M(self):
        ...
        for test_case in self.getTestCases(function_name, readVideoY4MTestCases):
            ...
            self.doTestVideoY4M(
                ...
                test_case.get("i_ydgcocg_packed", None),
                test_case.get("i_ydgcocg_planar", None),
                ...
                test_case.get("o_ydgcocg_packed", None),
                test_case.get("o_ydgcocg_planar", None),
    ...
    def doTestYDgCoCgPacked(
        self, expected_ydgcocg_packed, bayer_image, absolute_tolerance, test_name, label
    ):
        ydgcocg_packed = bayer_image.GetYDgCoCgPacked()
        np.testing.assert_allclose(
            ydgcocg_packed,
            expected_ydgcocg_packed,
            atol=absolute_tolerance,
            err_msg=f"error on {label} ydgcocg_packed case {test_name}",
        )

    def doTestYDgCoCgPlanar(
        self, expected_ydgcocg_planar, bayer_image, absolute_tolerance, test_name, label
    ):
    ...
    def doTestFull(
        ...
        if test_ydgcocg_packed is not None:
            self.doTestYDgCoCgPacked(
                test_ydgcocg_packed[frame_id],
                bayer_image,
                absolute_tolerance,
                test_name,
                label,
            )
        if test_ydgcocg_planar is not None:
            self.doTestYDgCoCgPlanar(
                test_ydgcocg_planar[frame_id],
                bayer_image,
                absolute_tolerance,
                test_name,
                label,
    ...
    def doTestY4MOutputFile(
        self, expected_output, output, dtype, absolute_tolerance, test_name
    ):
    ...
    def doTestVideoY4M(
        ...
        test_i_bayer_packed,
        test_i_bayer_planar,
        test_i_ydgcocg_packed,
        test_i_ydgcocg_planar,
        test_i_rgb_packed,
        test_i_rgb_planar,
        test_i_yuv_planar,
        test_o_pix_fmt,
        ...
        test_o_bayer_packed,
        test_o_bayer_planar,
        test_o_ydgcocg_packed,
        test_o_ydgcocg_planar,
        test_o_rgb_packed,
        test_o_rgb_planar,
        test_o_yuv_planar,
        test_output,
